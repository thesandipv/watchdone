...
import com.afterroot.ui.common.compose.components.TestColumnRecommended
        ...
        return ComposeView(requireContext()).apply {
            ...
            setContent {
                Theme(context = requireContext()) {
                    val lazyPagingItems = recommendedViewModel.recommendedShows.collectAsLazyPagingItems()
                    TestColumnRecommended(items = lazyPagingItems, onItemClick = { tv, i ->
                        Timber.d("onCreateView: Clicked $tv")
                    })
                }
            }
        }
