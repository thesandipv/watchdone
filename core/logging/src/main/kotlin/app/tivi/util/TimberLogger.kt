...
private class WDDebugTree : Timber.DebugTree() {
  override fun log(priority: Int, tag: String?, message: String, t: Throwable?) {
    super.log(
      priority,
      createStackElementTag(Throwable().stackTrace[7]) ?: "WatchDone",
      message,
      t,
    )
  }
...
private class CrashlyticsTree @Inject constructor(
