...
import com.afterroot.tmdbapi.model.Data;
import com.afterroot.tmdbapi.model.MovieDb;
import com.afterroot.tmdbapi.model.MovieImages;
import com.afterroot.tmdbapi.model.ProductionCompany;
import com.afterroot.tmdbapi.model.ReleaseInfo;
import com.afterroot.tmdbapi.model.Translation;
import com.afterroot.tmdbapi.model.Video;
import com.afterroot.tmdbapi.model.changes.ChangesItems;
...
public class MoviesApiTest extends AbstractTmdbApiTest {
    ...
    public void testGetMovieInfoWithAppendedMethods() {
        ...
        ProductionCompany productionCompany = Objects.requireNonNull(result.getProductionCompanies()).get(0);

        assertEquals("Incorrect movie information", "Blade Runner", result.getOriginalTitle());
        assertTrue("no videos", Objects.requireNonNull(result.getVideos()).size() > 0);
